        ...
        if new_name and new_name.strip() != '':
            if user_name:
                if new_name.lower() != user_name.lower():
                    ...
                    return "Thank you, {}, for assuring me your name. My name is Nuruzzaman.".format(user_name)
            else:
                self.chat_session.user_name = new_name
                return "Thank you, {}. BTW, my name is Nuruzzaman.".format(new_name)
        else:
            return "My name is Nuruzzaman. Thanks."
